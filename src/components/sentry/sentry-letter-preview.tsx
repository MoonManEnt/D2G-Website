      ...
      for (const finding of ocrFindings) {
        ...
        const className =
          finding.severity === "HIGH"
            ...
            : "bg-muted text-foreground px-1 rounded";
  ...
  return (
    <div className="bg-card rounded-lg border border-border">
      ...
      <div className="flex items-center justify-between p-4 border-b border-border">
        <h3 className="text-sm font-medium text-muted-foreground">Letter Preview</h3>
      ...
      <div className="p-4 max-h-[600px] overflow-y-auto">
        {content ? (
          <div
            className="font-mono text-sm text-muted-foreground whitespace-pre-wrap leading-relaxed"
          ...
          <div className="text-center py-12">
            ...
            <p className="text-sm text-muted-foreground">No letter content</p>
            <p className="text-xs text-muted-foreground mt-1">Generate a letter to preview</p>
          </div>
        )}
      </div>
