...
export const PRICING_FAQ = [
  {
    ...
    answer:
      "Yes. 3 active clients, 10 disputes per month, evidence center access — forever free. No credit card required. No time limit.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Yes — save up to 18% with annual billing. Solo drops to $65/mo, Starter to $107/mo, and Professional to $166/mo when paid annually.",
  },
  {
